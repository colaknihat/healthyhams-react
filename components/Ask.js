...
const App = ({navigation}) => {
  const [currentWeight, onChangeWeight] = React.useState(
    'What is your current weight?',
  );
  const [currentHeight, onChangeHeight] = React.useState(
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.allelements}>
        <Image
          ...
          source={require('../assets/images/ask_background_image.png')}
        />
        <Text style={styles.heading}>
          Let's do your diet <Text style={styles.highlight}>nadin</Text>
        </Text>
        <TextInput
        ...
        <View style={styles.nextbtn}>
          <TouchableOpacity
            ...
            <Image
              ...
              source={require('../assets/icons/forward_120px.png')}
            />
          </TouchableOpacity>
